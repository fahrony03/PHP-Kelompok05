...
<?php
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM dokumentasi WHERE slug = '".$slug."'");
        ...
        <div class="card">
            <div class="card-body">
                <blockquote class="blockquote mb-0">
                    ...
                    <br>
                    <p>
                        <img width="350px" height="100px" src="../../admin/menu/dokumentasi/images/<?= $nama ?>" class="img-fluid" alt="Responsive image">
                    </p>
                    <p><?= $content ?></p>
