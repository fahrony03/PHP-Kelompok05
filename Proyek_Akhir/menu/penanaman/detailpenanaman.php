...
<?php
    ...
    if (isset($_GET['detail'])) {
        $query = $pdo->prepare ("SELECT * FROM penanaman WHERE id = {$_GET['detail']}");
        ...
        <div class="card">
            <div class="card-body">
                <blockquote class="blockquote mb-0">
                    ...
                    <br>
                    <p>
                        <img width="350px" height="100px" src="../../admin/menu/penanaman/images/<?= $r['nama'] ?>" class="img-fluid" alt="Responsive image">
                    </p>
                    <p><?= $r['content'] ?></p>
