...
{
$update=mysqli_query($connect,"UPDATE pengelolaan set nama='$_POST[nama]' where id='$_POST[id]' ") or die ("gagal update ");
...
{
$update= mysqli_query($connect,"UPDATE pengelolaan set nama='$_POST[nama]',gambar='$filename' where id='$_POST[id]' ") or die ("gagal update gambar ");
echo "<script>alert ('data telah di update ');document.location='tampil_foto.php' </script> ";
}
?>