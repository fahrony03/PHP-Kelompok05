...
<html lang="en">
  ...
  session_start();
                    ...
                    ?>
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.php">Si-PEKA</a>
      ...
      <ul class="app-nav">
        ...
        <!-- User Menu-->
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><?php echo $_SESSION['username']; ?><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            <li><a class="dropdown-item" href="page-user.html"><i class="fa fa-cog fa-lg"></i> Settings</a></li>
            <li><a class="dropdown-item" href="page-user.html"><i class="fa fa-user fa-lg"></i> Profile</a></li>
            <li><a class="dropdown-item" href="../menu/auth/login.php"><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
          </ul>
        </li>
      </ul>
    </header>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Pages</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          ...
          <li><a class="treeview-item" href="menu/belanja"><i class="icon fa fa-circle-o"></i>Belanja</a></li>
            ...
            <li><a class="treeview-item active" href="menu/pengelolaan"><i class="icon fa fa-circle-o"></i> pengelolaan</a></li>
            <li><a class="treeview-item" href="menu/pemasaran"><i class="icon fa fa-circle-o"></i> pemasaran</a></li>
            <li><a class="treeview-item" href="menu/transaksi"><i class="icon fa fa-circle-o"></i> transaksi</a></li>
            <li><a class="treeview-item" href="menu/user"><i class="icon fa fa-circle-o"></i> Management User</a></li>
            <li><a class="treeview-item" href="menu/contact"><i class="icon fa fa-circle-o"></i> Contact</a></li>
          </ul>
        </li>
