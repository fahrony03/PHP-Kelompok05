...
<html lang="en">
  ...
  <?php
    ...
    <table border="1" class="table">
        ...
        $query_mysql = mysqli_query($koneksi,"select * from informasi");
        $nomor = 1;
        while ($data = mysqli_fetch_array($query_mysql)) {
        ?>
            <tr>
                <td><?php echo $nomor++; ?></td>
                <td><?php echo "<img src='informasi/$data[gambar]' width='70' height='90' />";?></td>
                <td><?php echo $data['title']; ?></td>
                <td><?php echo $data['content']; ?></td>
                <td>
                    <a href="../menu/edit.php?id=<?php echo $data['id']; ?>" class="edit">Edit</a>
                    <a href="../menu/hapus.php?id=<?php echo $data['id']; ?>" class="hapus">Hapus</a>
                </td>
            </tr>
        <?php } ?>
    </table>
