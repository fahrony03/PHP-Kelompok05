              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Masuk Melalui Array</h1>
                  </div>
                  <?php
                  session_start();
                  $username = 'fahrony@gmail.com';
                  $password = '12345';
                  ...
                  function display_login_form(){ ?>
                      ...
                      <input type="email" class="form-control form-control-user" name ="username" id="username" aria-describedby="emailHelp" placeholder="Masukkan Email">
                   </div>
                          <div class="form-group">
