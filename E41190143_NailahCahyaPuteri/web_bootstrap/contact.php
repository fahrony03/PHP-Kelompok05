...
<?php include "./sidebar.php" ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-contennt-between mb-4">
        ...
        <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
              ...
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weught=bold text-primary">Contact</h6>
            ...
            <form>
                ...
                <div class="form-group">
                <input type="text" class="form-control form-control-user" id="subject" name="subject" placeholder="Subjek Pesan Anda"
                required>
                </div>
                <div class="form-group">
