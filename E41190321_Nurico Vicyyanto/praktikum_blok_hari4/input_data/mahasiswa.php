    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Form Input Data Mahasiswa</h1>
        </div>
      ...
      <hr>
                    ...
                    <?php
                        ...
                        $tgl  = $_REQUEST['tgl'];
                        $mysqli  = "INSERT INTO `mahasiswa` (`nim`, `nama`, `alamat`, `no`, `jenis_kelamin`, `jurusan`,`tgl`) VALUES ('$nim', '$nama', '$alamat', '$no', '$jenis_kelamin', '$jurusan', '$tgl')";
